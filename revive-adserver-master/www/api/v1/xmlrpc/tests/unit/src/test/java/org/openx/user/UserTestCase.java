...
public class UserTestCase extends WebServiceTestCase {
	...
	protected static final String DELETE_USER_METHOD = "deleteUser";
	protected static final String MODIFY_USER_METHOD = "modifyUser";
	protected static final String GET_USER_METHOD = "getUser";
	protected static final String GET_USER_LIST_BY_ACCOUNT_ID_METHOD = "getUserListByAccountId";
	protected static final String UPDATE_SSO_USER_ID_METHOD = "updateSsoUserId";
	protected static final String UPDATE_USER_EMAIL_BY_SSO_ID_METHOD = "updateUserEmailBySsoId";
