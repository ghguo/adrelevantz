...
$cq = !empty($_GET) ? $_GET['q'] : $_POST['q'];
$zoneId = !empty($_GET) ? $_GET['zoneId'] : $_POST['zoneId'] ;
$deliveryId = !empty($_GET) ? $_GET['deliveryId'] : $_POST['deliveryId'];
...
require __DIR__.'/'.$GLOBALS['_MAX']['CONF']['file']['asyncmjsjs'];
